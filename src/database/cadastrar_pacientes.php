...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nome) || empty($nome_google) || empty($email) || empty($data_inicio) || empty($data_final) || empty($matricula) || empty($documento) || empty($especialidade) || empty($data_emissao) || empty($data_validade)) {
