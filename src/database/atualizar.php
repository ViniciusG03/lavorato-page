        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_FILES['excelFile']) && $_FILES['excelFile']['size'] > 0) {
                ...
                foreach ($data as $row) {
                    ...
                    $sqlUpdate = "UPDATE pacientes SET paciente_status=? WHERE paciente_guia=?";
                ...
                if (empty($numero_guia) || empty($status_guia)) {
                    ...
                    if ($entrada !== "" || $saida !== "" || $status_guia !== "" || $numero_lote !== "") {
                        ...
                        if ($result->num_rows == 0) {
                            echo '<h1>Número da guia não existe!</h1><br><p>Clique em "Home" para voltar a página principal!</p>';
                        } else {
